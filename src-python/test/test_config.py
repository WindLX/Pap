...
def test_read_basic_config():
    response = client.get("/api/get_config/basic")
...
def test_write_basic_config():
    ...
    response = client.put("/api/set_config/basic", json=put_data)
    ...
    response_2 = client.put("/api/set_config/basic", json=put_data_2)
